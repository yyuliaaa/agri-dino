...
def process_image(
        ...
        model_weights="weights/checkpoint_epoch_90.pth",
        image_path=r"E:\Gong\new\Grounding-Dino-FineTuning-main0\stamen_dataset0\images\train\DJI_0540.JPG",
        text_prompt="stamen",
        box_threshold=0.35,
        text_threshold=0.25
):
    model = load_model(model_config, model_weights)
    visualizer = GroundingDINOVisualizer(save_dir="visualizations_enhance")

    for img in os.listdir('./stamen_dataset0/images/test_s'):
        image_path=os.path.join('./stamen_dataset0/images/test_s',img)
...
if __name__ == "__main__":
    model_weights="weights/checkpoint_epoch_400.pth"
